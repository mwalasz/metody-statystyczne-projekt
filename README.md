...
- Wykresy zapisujemy w katalogu `source/assets`
...
## Zapisywanie wykresow

1. Wyplotuj wykres uzywajac funkcji `plot` 
1. W karcie `Plots` kliknij w zakladke `Export`
1. Ustaw poprawny katalog, nazwe i zapisz
